...
│ email_verif │ │ limit_one_response │
│ created_at │ │ FK creator_id (users.id) │
...
│ │ │
┌────────▼───────┐ ┌─────────▼────────┐ ┌───────▼──────────┐
│ allowed_domains│ │ questions │ │ responses │
├────────────────┤ ├──────────────────┤ ├──────────────────┤
│ PK id │ │ PK id │ │ PK id │
│ domain │ │ name │ │ FK form_id │
│ FK form_id │ │ choice_type │ │ FK user_id │
└────────────────┘ │ choices │ │ date │
│ is_required │ │ created_at │
│ FK form_id │ │ updated_at │
│ created_at │ └───────┬──────────┘
│ updated_at │ │ 1 to N
└──────────────────┘ ┌───────▼──────────┐
│ answers │
